...
public class TypeHelper {
    ...
    public boolean isHex(String Hex, int size) {
        ...
        return (Hex.substring(0, Hex.length() - 1).matches("[0123456789ABCDEF]*")) && (Hex.length() - 1 == size) && (Hex.substring(size).equals("H"));
    }
    ...
    public boolean isBin(String Bin, int size) {
        ...
        if (Bin.length() == 0)
            return false;
        return (Bin.substring(0, Bin.length() - 1).matches("[01]*")) && (Bin.length() - 1 == size) && (Bin.substring(size).equals("B"));
    }
    ...
    public boolean isDec(String Dec, int size) {
        ...
        if (Dec.length() == 0)
            return false;
        return (Dec.substring(0, Dec.length() - 1).matches("[0123456789]*")) && (Integer.parseInt(Dec.substring(0, Dec.length() - 1)) <= size) && (Dec.substring(Dec.length() - 1).equals("D"));
    }
}
